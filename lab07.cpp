...
int main() {
    ...
    int N1 = 2;
    int K1 = 2;
    vector<int> resultado1 = jugarJuego(habilidades1, N1, K1);
    ...
    int N2 = 10;
    int K2 = 399;
    vector<int> resultado2 = jugarJuego(habilidades2, N2, K2);
    cout << resultado2[0] << " " << resultado2[1] << endl;

    vector<int> habilidades3 = {1, 2, 3};
    int N3 = 2;
    int K3 = 4;
    vector<int> resultado3 = jugarJuego(habilidades3, N3, K3);
    cout << resultado3[0] << " " << resultado3[1] << endl;

    vector<int> habilidades4 = {30, 12};
    int N4 = 34;
    int K4 = 80;
    vector<int> resultado4 = jugarJuego(habilidades4, N4, K4);
